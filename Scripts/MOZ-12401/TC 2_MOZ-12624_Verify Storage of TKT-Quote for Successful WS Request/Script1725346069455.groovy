...
HashMap<String, String> dbMap1 = processJson.getColumnsWithJsonPath("mi_refund_ek_quote_passenger")
processJson.verifyJsonElementsValuesWithDatabaseValues(filePath,dbMap1,mi_refund_ek_quote_passenger)

HashMap<String, String> dbMap2 = processJson.getColumnsWithJsonPath("mi_refund_ek_quote_tkt_details")
processJson.verifyJsonElementsValuesWithDatabaseValues(filePath,dbMap2,mi_refund_ek_quote_tkt_details)

HashMap<String, String> dbMap3 = processJson.getColumnsWithJsonPath("mi_refund_ek_quote_tkt_coupon_details")
processJson.verifyJsonElementsValuesWithDatabaseValues(filePath,dbMap3,mi_refund_ek_quote_tkt_coupon_details)

HashMap<String, String> dbMap4 = processJson.getColumnsWithJsonPath("mi_refund_ek_quote_tkt_original_fare")
processJson.verifyJsonElementsValuesWithDatabaseValues(filePath,dbMap4,mi_refund_ek_quote_tkt_original_fare)

HashMap<String, String> dbMap5 = processJson.getColumnsWithJsonPath("mi_refund_ek_quote_tkt_penalty_charges")
processJson.verifyJsonElementsValuesWithDatabaseValues(filePath,dbMap5,mi_refund_ek_quote_tkt_penalty_charges)

HashMap<String, String> dbMap6 = processJson.getColumnsWithJsonPath("mi_refund_ek_quote_tkt_refund_fare")
processJson.verifyJsonElementsValuesWithDatabaseValues(filePath,dbMap6,mi_refund_ek_quote_tkt_refund_fare)

HashMap<String, String> dbMap7 = processJson.getColumnsWithJsonPath("mi_refund_ek_quote_tkt_used_fare")
processJson.verifyJsonElementsValuesWithDatabaseValues(filePath,dbMap7,mi_refund_ek_quote_tkt_used_fare)
